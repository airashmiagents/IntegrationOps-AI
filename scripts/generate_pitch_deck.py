...
def _flow_architecture(slide) -> None:
    ...
    caption = (
        ...
        "OpenRouter (Gemma 4 31B IT free + Llama 3.3 70B instruct free fallback) → structured RCA → SQLite + mock inbox + Jira-ready fields"
    )
...
def build() -> None:
    ...
    _bullets(
        ...
        [
            ...
            "OpenRouter (two distinct :free models — Gemma 4 31B IT + Llama 3.3 70B instruct fallback) — httpx, JSON-mode prompts.",
